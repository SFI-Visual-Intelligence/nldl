...
% If you are typesetting the camera ready in January, you must set this!
%\confYear{2042}
...
The submissions can be either (1)~a 2-page extended abstract (non-archival), using the \verb|abstract| option, or (2)~a 5 to 8 pages full paper (included in proceedings) in the area of Deep Learning, using the \verb|fullpaper| option.
...
For the camera-ready version, the main paper is limited to 8 pages.
Authors must address the reviewers' comments within this limit.
However, the appendix is still unlimited.
If revisions cause the paper to exceed the page limit, authors should compress the content in the main paper and relocate additional results to the appendix in order to adequately address the comments.
